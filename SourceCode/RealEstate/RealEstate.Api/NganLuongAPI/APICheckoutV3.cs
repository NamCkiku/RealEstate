...
namespace RealEstate.Api.NganLuongAPI
{
    public class APICheckoutV3
    {

        public ResponseInfo GetUrlCheckout(RequestCheckoutInfo requestContent, string payment_method = "NL")
        {

            requestContent.Payment_method = payment_method;
            String RequestCheckoutInfo = GetParamPost(requestContent);
            String result = HttpPost(RequestCheckoutInfo);
        ...
        private static String GetParamPost(RequestCheckoutInfo info)
        {
    ...
    #region Entity RequestCheckoutInfo
    public class RequestCheckoutInfo
    {
