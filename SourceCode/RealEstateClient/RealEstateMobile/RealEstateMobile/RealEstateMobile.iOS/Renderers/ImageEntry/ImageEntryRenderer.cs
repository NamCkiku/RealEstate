...
using Foundation;
using UIKit;
using RealEstateMobile.iOS.Renderers.ImageEntry;
using Xamarin.Forms;
...
namespace RealEstateMobile.iOS.Renderers.ImageEntry
{
    public class ImageEntryRenderer : EntryRenderer
    {
        protected override void OnElementChanged(ElementChangedEventArgs<Entry> e)
        {
            ...
            var element = (RealEstateMobile.Controls.ImageEntry)this.Element;
